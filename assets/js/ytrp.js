...
jQuery(document).ready(function ($) {
	...
	// ########## On Redirection Type Change ########
	
	var optionSelected = $('#ytrp-redirect_type').find(":selected").val();
	if(optionSelected=="inline-frame")
	{
		$('.red-type-select').hide();
	}
	else
	{
		$('.red-type-select').show();
	}
	
	$('#ytrp-redirect_type').on('change', function (e) {
	...
	// ########## On Redirection Counter/Term Change ########
	
	var optionSelected = $('#ytrp-counteraccept').find(":selected").val();
	if(optionSelected=="terms")
	{
		$('.redtime-class').hide();
	}
	else
	...
	function ytrp_counteraccept()
	{
		var optionSelected = $('#ytrp-counteraccept').val();
		if(optionSelected=="terms")
		{
			$('.redtime-class').hide();
		}
	...
	$('#ytrp-counteraccept').on('change', function (e) {
		var optionSelected = $(this).val();
		if(optionSelected=="terms")
		{
			$('.redtime-class').hide();
