...
<a href="http://<?php echo $ytrp_url;?>" class="agree"><?php echo __('I Accept', 'yt-redirection-pages'); ?></a> <a href="<?php echo home_url(); ?>" class="reject"><?php echo __('I Reject', 'yt-redirection-pages'); ?></a>
</div>
<?php } ?>
