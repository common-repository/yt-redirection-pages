...
function yrtp_func_firstpage($ytrp_url,$ytrp_time,$ytrp_customtxt,$ytrp_notetext,$ytrp_copyrighttext,$ytrp_logo,$ytrp_counteraccept,$ytrp_noticetext)
{
?>
...
<?php wp_enqueue_style( 'ytrp-firstpage-css', plugin_dir_url( __FILE__ ) . 'style.css', false, "1.0.1", "all"  ); ?>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex,nofollow"/>
</head>
<body class="ytrp-firstpage">
<div class="logo" >
<?php if($ytrp_logo) { ?>
...
<div class="cbtn" ><a href="http://<?php echo $ytrp_url;?>" rel="follow"/><?php echo __('Click here if your not redirected', 'yt-redirection-pages'); ?></a></div>
<?php } else { ?>

<div class="ctitle"><?php echo $ytrp_noticetext; ?></div>
<div class="cbin" >
<ul>
<li><a href="http://<?php echo $ytrp_url;?>" rel="follow"/><span class="lb" ><?php echo __('YES', 'yt-redirection-pages'); ?></span>&nbsp;&nbsp; PLEASE&nbsp;&nbsp;&nbsp;</a></li>
